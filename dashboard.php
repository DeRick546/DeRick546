...
<body> 
  <nav>
    <ul class="nav">
      ...
      <li class="nav_word">
        <!--<div class="dropdown">-->
        <a href="dashboard.php" class="on">Dashboard<!--<i class="fa fa-caret-down"></i>--></a>
  ...
  <table>
    <tr>
      ...
      <th class="text-center">Lessen </th>
      <th class="text-center">Beoordeling </th>
      <th class="text-center">Cijfers </th>
      <th class="text-center">Studie-punten</th>
    </tr>
    <tr>
        ...
        <td class="text-center">2.5 EC</td>
    </tr>
    <tr>
        <td>Computer Science Basics (CSB)</td>
        <td>Tentamen</td>
        <td class="text-center">n/a</td>
        <td class="text-center">5 EC</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Criterium gericht interview</td>
        <td class="text-center">n/a</td>
        <td class="text-center">12.5 EC</td>
    </tr>
    <tr>
        <td>IT Personality Projectweek 1</td>
        <td>Portfolio</td>
        <td class="text-center">n/a</td>
        <td class="text-center">1.25 EC</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Tentamen</td>
        <td class="text-center">n/a</td>
        <td class="text-center">4 EC</td>
    </tr>
    <tr>
        <td>Tentamen</td>
        <td class="text-center">n/a</td>
        <td class="text-center">1 EC</td>
    </tr>
    <tr>
        <td>Presentatie (per groepje)</td>
        <td class="text-center">n/a</td>
    ...
    <tr>
        ...
        <td>Laatste inlevering per groepje</td>
        <td class="text-center">n/a</td>
        <td class="text-center">2.5 EC</td>
    </tr>
    <tr>
        <td>Individueel Project onderzoek</td>
        <td class="text-center">n/a</td>
        <td class="text-center">2.5 EC</td>
    </tr>
    <tr>
    ...
    <tr>
      <th  colspan="5"><p class="NBSA">NBSA: 45EC min en propedeuse: 60EC max</p></th>
      </tr>
</table>
